...
* FR: document event directions/expectations
    - which events can we send back to the host?
        > note_end, param_value, ..
    - which events will the host pass on to the next plugin?
        > note effects: note on/off, expressions, ..
